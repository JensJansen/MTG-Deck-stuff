"""
Shared .env loader for the V2 stack.

Reads V2/src/distributed scraper/.env into os.environ. If the file does not
...
def load_env() -> None:
    if not _ENV_FILE.exists():
        if os.environ.get("DATABASE_URL") or os.environ.get("API_KEY"):
            return
