-- V32: Fix integer overflow in lift/pmi computation
--
-- cc_a.deck_count * cc_b.deck_count was evaluated as INT × INT.
-- For formats with popular cards (e.g. pauper with ~50k+ decks), the product
-- can exceed INT max (2,147,483,647), causing NumericValueOutOfRange.
-- Casting one operand to BIGINT before multiplication prevents the overflow.
